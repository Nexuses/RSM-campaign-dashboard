...
export function CampaignDetailView() {
  ...
  // Use sheetsData which already includes campaign data from "1-1 RSM : All Campaign"
  const filteredData = useMemo(() => {
    // Use sheetsData directly (no need to combine with oneOnOneData since it's already included)
    const allData = sheetsData || []
